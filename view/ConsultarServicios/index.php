		...
		<div class="page-content">
			<div class="container-fluid">
				...
				<div class="box-typical box-typical-padding">
					<button type="button" id="btnnuevo" class="btn btn-inline btn-primary">Listado de Servicios</button>
					<table id="servicios_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
						<thead>
							<tr>
								<th style="width: 1%;">Numero de Servicio</th>
								...
								<th class="d-none d-sm-table-cell" style="width: 5%;">Costo</th>
