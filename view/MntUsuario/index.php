				...
				<table id="usuario_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
					<thead>
						<tr>
							...
							<th class="d-none d-sm-table-cell" style="width: 1%;">Correo</th>
							<th class="d-none d-sm-table-cell" style="width: 1%;">Contraseña</th>
							<th class="d-none d-sm-table-cell" style="width: 1%;">Rol</th>
