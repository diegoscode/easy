    ...
    <div class="page-center">
        <div class="page-center-in">
            ...
            <form class="sign-box" action="" method="post" id="login_form">
                ...
                <header class="sign-title" id="lbltitulo">Registro</header>
                ...
                <div class="form-group">
                    <input type="text" id="tip_per" name="tip_per" class="form-control" placeholder="Tipo de empresa o particular"/>
                </div>
                ...
                <div class="float-left reset">
                    <a href="login.php">Si ya tienes cuenta, inicia sesion.</a>
                </div>
